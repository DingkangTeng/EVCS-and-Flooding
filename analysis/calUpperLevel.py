...
class calUpperLevel:
    ...
    def agg(self, aggType: str | list[str]) -> None:
        aggType = ["city", "iso3"] if aggType == "city" else aggType
        ...
        df.to_csv(
            os.path.join(self.savePath, "{}.csv".format(aggType if isinstance(aggType, str) else aggType[0])),
